...
class BuildCardActivities extends StatefulWidget {
  final String? activityThumbnail;
  final String activityName;
  final dynamic activityData;
  const BuildCardActivities({super.key,
  ...
  @override
  State<BuildCardActivities> createState() => _BuildCardActivitiesState();
}

class _BuildCardActivitiesState extends State<BuildCardActivities> {
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ClipRoundedImage(
                imageUrl: widget.activityThumbnail?? '', // Empty string triggers fallback
                height: 200,
