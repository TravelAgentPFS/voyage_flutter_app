      ...
      body: SafeArea(
        child: Stack(
          ...
          children: [
            ...
            resultsReady?const SizedBox.shrink():Positioned(
              top: size.height*0.2,
              left: 0,
              right: 0,
              child: hasEnteredQuery? const Center(child: CircularProgressIndicator(backgroundColor: Color.fromARGB(255, 100, 100, 100),strokeWidth: 9,color: Color.fromARGB(255, 0, 0, 0)))
                              :const Text("Where would you like to go?",textAlign: TextAlign.center,
                                      style: TextStyle( color: Color.fromARGB(255, 77, 77, 77),
                                          fontSize: 25,fontFamily: "monospace",fontWeight: FontWeight.w500,),
                                      ),
              ),
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                    ...
                    prefixIcon: isTextFieldEmpty? const Icon(Icons.search)
                                  : IconButton(
